...
//            this.controlador.salvarHistorico(this.historico);   
    ...
    public String getAutoresLivroSelecionado() {
        if (this.livroSelecionado != null) {
            return this.livroSelecionado.getNomeAutoresABNT(this.livroSelecionado.getId());
        }
        return null;
    }
    ...
    /**
     * Atualiza a disponibilidade para edição do amigo, caso o check box de
     * finalizaçã seja alterado
     */
    ...
    /**
     * Seta o bookLock do livro para o usuário que pressionou o botão de editar,
     * e também verifica se o livro já não está com lock setado.
     *
