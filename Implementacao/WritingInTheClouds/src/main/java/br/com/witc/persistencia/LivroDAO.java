...
public class LivroDAO {
     ...
     * @throws br.com.witc.excessao.BibliotecaVirtualVaziaException Caso não
     * haja livros publicados na Biblioteca
     */
    ...
    public List<Livro> listarLivrosRevisao() {
        List<Livro> livros = sessao.createQuery("from Livro where disponivelRevisao = 0").list();
        return livros;
    }
}
